...
# enumerate
'''
هر زمان استفاده از این تابع(چه در لوپ و چه لیست کامپرهنشن)
اولین متغیر بعد از فور،کانتر تابع مذکور است 
و این کانتر(اسمش ایندکس باشد یا نه)، ایندکس 
المنت های مجموعه را میگیرد
'''
# ---------------------------------------------
p = print
...
# مثال ها :
# ============================================
# ۱. لیستی از تاپل‌ها (مختصات) — لوپ دومتغیره
# ============================================
points = [(1, 2), (3, 5), (0, 8)]
p = print
for i , j in points:
    p(f"first tuple elements is {i} and  second one is {j}")
# ============================================
# ۲. خروجی ()zip — لوپ دومتغیره
# ============================================
names = ["ali", "sara", "Reza"]
scores = [18, 20, 15]    
new = []
...
p(new) 
# ============================================
# ۳. خروجی ()enumerate — لوپ دومتغیره
# ============================================
p = print
days = ["satureday","sunday","monday","tuesday"]
for index,day in enumerate(days):     
    p(f"{index}: Today is {day} ") 
# ============================================
# ۴. دیکشنری با ()items. — لوپ دومتغیره
# ============================================
student = {"name": "Maryam", "age": 22, "grade": "A"}
for key, value in student.items():
    pass
# ============================================
# ۵. باز کردن بیش از دو متغیر (سه‌بعدی) — لوپ سه‌متغیره
# ============================================
points_3d = [(1, 2, 3), (4, 5, 6)]
for x, y, z in points_3d:
    p("(first: ",x, "(second: ",y ,"(third: ",z)

# ============================================
# ۶. باز کردن تودرتو (nested unpacking) — لوپ چهارمتغیره
# ============================================
students = [
    ("Ali", [18, 20, 19]),
    ("Sara", [15, 14, 16])
]
for name,(chemistry, ecology, math) in students:
    p(f"name: {name} (scores: chemistry:{chemistry},ecology: {ecology} , math: {math})")
# ------------------------------------------------
