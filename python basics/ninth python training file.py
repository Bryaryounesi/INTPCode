...
print("-------------------------")
# تبدیل دیکشنری به لیست  با لیست کامپرهنشن
# تبدیل دیکشنری به تاپل
...
tuple_list = [ i for i in dico.items()]   #تبدیل کلید مقدارها به لیستی تاپلی [(key1,value1), ...]
key_list = [ i for i in dico.keys()]      #تبدیل کلیدها به یک لیست
value_list = [ i for i in dico.values()]   #تبدیل والیو ها به لیست
# --------------------------------------------------------
