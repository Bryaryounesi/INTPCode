...
# مرتب سازی به صورت پیشفرض از منفی به مثبت
# با پارامتر ریورس ترو در لیست سورت، میتوان از مثبت به منفی لیست ها را مرتب کرد
...
# بدون پارامتر ریورس ترو، مرتب سازی رشته ها به ترتیب الفبا
names = ["cloe", "bill", "ana"]
